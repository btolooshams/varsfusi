...
finetune monkey reduced-sampling
...
def main():
    ...
    params.interleaved = int(np.floor(250 / params.num_frames))

    session_name = params_init.train_finetune_dataset.split("/")[-2]
    train_name = f"reducedsampling_{params_init.num_train_finetune}_{session_name}"
    ...
    if params.model == "VARSfUSI":
        train_dataset = datasetloader.FUSdatasetDynamicsTrainSizeIQDOPsvdinterleaved(
        ...
        if params.val_finetune_dataset:
            val_dataset = datasetloader.FUSdatasetDynamicsTrainSizeIQDOPsvdinterleaved(
        ...
        if params.test_finetune_dataset:
            test_dataset = datasetloader.FUSdatasetDynamicsTrainSizeIQDOPsvdinterleaved(
        ...
        if params.test_out_finetune_dataset:
            test_dataset_out = (
                datasetloader.FUSdatasetDynamicsTrainSizeIQDOPsvdinterleaved(
        ...
        train_dataset = datasetloader.FUSdatasetDynamicsTrainSizeinterleaved(
            params.train_finetune_dataset,
            num_data=params.num_train_finetune,
            num_frames=params.num_frames,
            iq_signal_mode=params.iq_signal_mode,
        ...
        if params.val_finetune_dataset:
            val_dataset = datasetloader.FUSdatasetDynamicsTrainSizeinterleaved(
                params.val_finetune_dataset,
                num_data=None,
                num_frames=params.num_frames,
                iq_signal_mode=params.iq_signal_mode,
            ...
            val_dataset = None
        if params.test_finetune_dataset:
            test_dataset = datasetloader.FUSdatasetDynamicsTrainSizeinterleaved(
                params.test_finetune_dataset,
                num_data=None,
                num_frames=params.num_frames,
                iq_signal_mode=params.iq_signal_mode,
            ...
            test_dataset = None
        if params.test_out_finetune_dataset:
            test_dataset_out = datasetloader.FUSdatasetDynamicsTrainSizeinterleaved(
                params.test_out_finetune_dataset,
                num_data=None,
                num_frames=params.num_frames,
                iq_signal_mode=params.iq_signal_mode,
