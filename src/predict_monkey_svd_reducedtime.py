...
prediction monkey reduced-time
...
def main():
    ...
    datasetname = "FUSdatasetforSVDGeneral"
    svd = 38
    ...
    for test_data_path in params.test_data_path_list:
        ...
        for num_frames in num_frames_list:
            ...
            r_path = os.path.join(
                out_path,
                f"{params.test_name}_{params.num_frames}frames_reducedtime_{params.decimation_factor}decimation_svdfusi.pt",
            )

            r_path_ll = os.path.join(
                out_path,
                f"{params.test_name}_{params.num_frames}frames_reducedtime_{params.decimation_factor}decimation_oraclesvd.pt",
            )
