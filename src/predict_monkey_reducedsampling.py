...
predict monkey reduced-sampling
...
def main():
    print("Predict on monkey reduced-sampling.")
    ...
    for test_data_path in params_init.test_data_path_list:
        ...
        for res_path in res_path_list:
            ...
            params.interleaved = int(np.floor(total_frames / params.num_frames))
            ...
            if params.model == "VARSfUSI":
                ...
                test_dataset = datasetloader.FUSdatasetIQDOPsvdGeneralinterleaved(
                ...
                test_dataset = datasetloader.FUSdatasetinterleaved(
                    params_init.test_data_path,
                    num_frames=params.num_frames,
                    iq_signal_mode=params.iq_signal_mode,
                    interleaved=params.interleaved,
            ...
            test_path = os.path.join(
                out_path_general,
                f"{params_init.test_name}_{params.num_frames_to_test}frames_reducedsampling_{params.pad}_{params_init.checkpoint_type}.pt",
            )
