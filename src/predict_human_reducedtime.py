...
def main():
    print("Predict on human reduced-time.")
    ...
    test_path_no = os.path.join(
        out_path_general,
        f"{test_name}_{params.num_frames}frames_reducedtime_{params.model_type}_method.pt",
    )
    test_path_oracle_svd = os.path.join(
        out_path_general,
        f"{test_name}_{params.num_frames}frames_reducedtime_{params.model_type}_oraclesvd.pt",
    )
    test_path_svd_fusi = os.path.join(
        out_path_general,
        f"{test_name}_{params.num_frames}frames_reducedtime_{params.model_type}_svdfusi.pt",
    )
