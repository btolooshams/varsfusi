...
finetune human reduced-sampling
    ...
    pipe = configmypy.ConfigPipeline(
        [
            configmypy.YamlConfig(
                config_file="./human_finetune_training_reducedsampling.yaml",
                config_name="default",
...
def main():
    ...
    params.out_path = f"{params_init.out_path}_{train_finetune_dataset_name}_{model_name}_{num_train_data}data_reducedsampling_{random_date}"
    ...
    if params.model == "VARSfUSI":
        train_dataset = datasetloader.FUSdatasetOnlineSettingforTrainingDynamicTrainSizeIQDOPsvdinterleaved(
        ...
        train_dataset = (
            datasetloader.FUSdatasetOnlineSettingforTrainingDynamicTrainSizeinterleaved(
                params.train_finetune_dataset,
                svd=params.svd_for_training,
                num_data=params.num_data,
                num_frames=params.num_frames,
